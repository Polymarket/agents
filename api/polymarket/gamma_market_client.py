...
class GammaMarketClient:
    ...
    def get_current_markets(self, limit=2):
        return self.get_markets(querystring_params={ 'active': True, 'closed': False, 'archived': False, 'limit': limit })
    
    def get_current_events(self, limit=2):
        return self.get_events(querystring_params={ 'active': True, 'closed': False, 'archived': False, 'limit': limit })

    def get_clob_tradable_markets(self, limit=2):
        return self.get_markets(querystring_params={ 'active': True, 'closed': False, 'archived': False, 'limit': limit, 'enableOrderBook': True })
